module "build_nginx_nodejs_2023_supervisord_docker_image" {
  source = "../codebuild_job"

  name              = "build-nginx-nodejs-2023-supervisord-docker"
  build_description = "Codebuild for Building Nginx and Supervisord On NodeJS 16 Base With amazonlinux:2023"
  repository_name   = "bichard7-next-infrastructure-docker-images"
  buildspec_file    = "./Nginx_NodeJS_2023_Supervisord/buildspec.yml"
