module "build_nodejs_20_2023_docker_image" {
...
module "build_nodejs_20_2023_docker_image_schedule" {
  source          = "../codebuild_schedule"
  codebuild_arn   = module.build_nodejs_20_2023_docker_image.pipeline_arn
  name            = module.build_nodejs_20_2023_docker_image.pipeline_name
