...
| <a name="provider_aws.preprod"></a> [aws.preprod](#provider\_aws.preprod) | 3.56.0 |
| <a name="provider_aws.production"></a> [aws.production](#provider\_aws.production) | 3.56.0 |
| <a name="provider_aws.sandbox"></a> [aws.sandbox](#provider\_aws.sandbox) | 3.56.0 |
| <a name="provider_aws.shared"></a> [aws.shared](#provider\_aws.shared) | 3.56.0 |
...
| Name | Type |
|------|------|
| [aws_route53_record.bichard7_pathtolive_name_servers](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_record) | resource |
| [aws_route53_zone.bichard7_pathtolive_delegated_zone](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route53_zone) | resource |
